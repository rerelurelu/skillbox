---
name: dig
description: "Deep exploratory interview that uncovers hidden assumptions, undiscovered risks, and unconsidered decisions in a plan through iterative AskUserQuestion rounds. Use when the user has a draft plan and wants it stress-tested, asks to dig into a plan, identify ambiguities, or surface unknowns."
version: "3.0.0"
user-invocable: true
context: fork
