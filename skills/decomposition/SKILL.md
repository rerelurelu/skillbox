---
name: decomposition
description: "Decomposes complex tasks into detailed, actionable todos with rich descriptions executable from the description alone. Use when the user has a large task that needs breaking down, asks for a task breakdown, plan, or checklist, or wants to start a new feature with clear milestones."
version: "1.1.0"
user-invocable: true
context: fork
...
- AGENTS.md (if available) for project context
