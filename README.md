...
| [writing-style-jp](skills/writing-style-jp/SKILL.md) | Rules for Japanese technical prose that a reader outside the field can follow: concrete replacements for abstract wording, a list of words to avoid, extra rules for design docs, and a pre-send checklist |
